...
uniform DirectionalLight directional_light_stationary;
uniform DirectionalLight directional_light_rotating;
...
void main() {
    ...
    colour += calculate_directional_light_colour(directional_light_stationary);
    colour += calculate_directional_light_colour(directional_light_rotating);
